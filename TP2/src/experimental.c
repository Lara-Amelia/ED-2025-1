//geração de entradas para a análise experimental
...
int main()
{
  ...
  int transportcost = 640;
  int transportinterval = 100;
  int retrievecost = 1;
  int nodes = 20;
  //gerando tudo constante e com X pacotes (variando a quantidade de pacotes no sistema)
  int numpackets = 50;
  int conncomp = nodes;
  long atime=1;
  long rtime=10;
